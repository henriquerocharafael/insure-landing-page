  ...
  return (
    <StyledFooter>
      ...
      <svg
        ...
        height="231"
      >
        <g fill="none" fill-rule="evenodd" stroke="#837d87">
      ...
      <Wrapper>
        <FooterHeader>
          ...
          <IconsHeader>
            <a href="#">
              <AiFillFacebook className="icon" size={24} color="#837d87" />
            </a>
            <a href="#">
              <AiOutlineTwitter className="icon" size={24} color="#837d87" />
            </a>
            <a href="#">
              <BsPinterest className="icon" size={24} color="#837d87" />
            </a>
            <a href="#">
              <FaInstagram className="icon" size={24} color="#837d87" />
            </a>
          </IconsHeader>
        </FooterHeader>
        <hr />
